...
export const baseInfoForm: FormConfig = {
  ...
  children: [
    ...
    { width: 690, label: '企业简介', name: 'companyDescription', type: FormType.Textarea, required: true, placeholder: '请输入简介，50～300个字',
      minLength: 50, maxLength: 300, patternList: [ { pattern: /^[a-zA-Z0-9\u4e00-\u9fa5]{50,300}$/, message: '50～300个字'}  ] },
...
export const articleForm: FormConfig = {
  ...
  children: [
    ...
    { inputWidth: 395, className:'f-middle', label: '文章标题', name: 'name', type: FormType.Input, required: true, maxLength: 30, placeholder: '请输入标题，2~30个字',minLength:2 },
...
export const productForm: FormConfig = {
  ...
  children: [
    ...
    { inputWidth: 395, className:'f-middle', label: '服务名称', name: 'name', type: FormType.Input, required: true, maxLength: 30, placeholder: '请输入标题，2~30个字', minLength:2 },
...
export const tdkForm: FormConfig = {
  name: 'tdkForm',
  children: [
    { inputWidth: 260, className:'f-middle', label: 'SEO标题', name: 'title', type: FormType.Input, required: true, minLength: 9, maxLength: 15,placeholder: '请输入标题，9~15个字'},
