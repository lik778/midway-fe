...
export const baseInfoForm: FormConfig = {
  name: 'baseInfoForm',
  children: [
    { inputWidth: 260, label: '企业名称', name: 'companyName', type: FormType.Input, required: true, maxLength: 20, minLength: 2,placeholder: '请输入企业名称，2~20个字', disabled: false, showCount: true },
    { inputWidth: 260, label: '企业别称', name: 'companyAlias', type: FormType.Input, required: false, maxLength: 20, minLength: 2,placeholder: '请输入企业别称，2~20个字',showCount: true },
    { width: 376, label: '企业地址', name: 'area', type: FormType.AreaSelect, required: true },
    { inputWidth: 260, label: '详细地址', name: 'companyAddress', type: FormType.Input, required: true, placeholder: '详细地址（如街道、门牌号等）' },
