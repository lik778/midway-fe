...
export const productForm: FormConfig = {
  ...
  children: [
    ...
    { inputWidth: 150, label: '图片信息', name: 'headImg', type: FormType.ImgUpload, required: false, maxNum:2 ,tip:'图片格式：jpg、jpeg、png，大小不超过1M，图片比例3：2，建议最小尺寸300*200' },
    { inputWidth: 542, label: '服务描述', name: 'headImg', type: FormType.Textarea, required: true, minLength: 100, maxLength: 1000,placeholder: '请输入简介，100～1000个字' },
  ],
  buttonConfig: { text: '提交', size: 'large', className: 'mvip-btn' }
}
