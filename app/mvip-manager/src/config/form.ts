...
export const articleForm: FormConfig = {
  ...
  children: [
    ...
    { inputWidth: 130, className:'f-tag', label: '标签', name: 'tags', type: FormType.Tag, required: true, minLength:1, maxLength: 8, placeholder: '输入标签',  maxNum: 20 },
...
export const productForm: FormConfig = {
  ...
  children: [
    ...
    { inputWidth: 130, className:'f-tag', label: '标签', name: 'tags', type: FormType.Tag, required: true, minLength:1, maxLength: 10, placeholder: '输入标签',  maxNum: 20},
