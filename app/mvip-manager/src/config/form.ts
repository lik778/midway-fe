...
export const productForm: FormConfig = {
  ...
  children: [
    ...
    { inputWidth: 542, className:'f-textarea', label: '服务描述', name: 'description', type: FormType.Textarea, required: true, minLength: 100, maxLength: 1000,placeholder: '请输入简介，100～1000个字' },
  ],
  buttonConfig: { text: '提交', size: 'large', className: 'mvip-btn' }
}
