...
export const articleForm: FormConfig = {
  ...
  children: [
    ...
    { inputWidth: 150, className:'f-img', label: '图片信息', name: 'imgInfo', type: FormType.ImgUpload, required: false, maxNum: 1, images: [{text:'企业logo', name: 'logoImg'}], tip:'图片格式：jpg、jpeg、png，大小不超过1M，图片比例3：2，建议最小尺寸300*200' },
