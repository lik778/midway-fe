...
export const productForm: FormConfig = {
  ...
  children: [
    ...
    { inputWidth: 130, className:'f-tag', label: '标签', name: 'tags', type: FormType.Tag, required: true, minLength:1, maxLength: 10, placeholder: '输入标签',  maxNum: 30, minNum: 3},
    { inputWidth: 150, className:'f-img', label: '图片信息', name: 'imgInfo', type: FormType.ImgUpload, required: false, maxLength: 2, images: [{text:'用于封面', name: 'headImg', maxSize: 1}, {text: '用于正文介绍', name: 'contentImg', maxSize: 1}],
