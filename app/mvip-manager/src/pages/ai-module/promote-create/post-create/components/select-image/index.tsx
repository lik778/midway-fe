...
const SelectImage = (props: Props, parentRef: Ref<any>) => {
  ...
  return <Form.Item labelCol={fromLabelCol} label="图片" required={true} help={help} validateStatus={validateStatus}>
    <div className={styles['img-upload-container']}>
      <ImgUpload value={initEditData} uploadType={2} unique={true} uploadBtnText={'选择照片'} maxSize={maxSize} maxLength={maxLength} cropProps={{ aspectRatio: 1024 / 768, autoAspectRatio: true }} onChange={handleChangeImg} disabled={disabled} />
    </div>
