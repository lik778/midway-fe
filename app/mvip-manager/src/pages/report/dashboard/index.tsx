    ...
    series : [
      {
        ...
        data:[
          { value: fm || 0, name:'凤鸣', },
          { value: bw || 0, name:'标王' },
          { value: qc || 0, name:'易慧推广告' },
          { value: cate || 0, name:'快照' }
        ],
        ...
        { !loading && <div>
          <div className="segment">
            <h2>账户信息<span style={{ fontSize: 12, color: 'rgba(0, 0, 0, 0.45)' }}>
              （说明：关键词数据每周更新一次；快照数据包含店铺、帖子、问答；广告数据包含标王、凤鸣、易慧推广告。）</span></h2>
            <Row className="statics-con" gutter={16}>
              ...
              <Col className="statics" span={8}>
                <CountTo title="快照关键词数" type={ReportProductType.CATE} value={overview?.mainTotalKeyword}/>
              </Col>
            </Row>
            <Row className="statics-con" gutter={16}>
              <Col className="statics" span={8}>
              ...
              <Col className="statics" span={8}>
                <CountTo title="易慧推广告关键词数" type={ReportProductType.YIHUITUI} value={overview?.yiHuiTuiKeyword}/>
              </Col>
            </Row>
          </div>
          <div className="segment">
