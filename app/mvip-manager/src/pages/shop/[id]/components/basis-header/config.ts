...
export const RecordForm: FormConfig = {
  ...
  children: [
    ...
    { formItemWidth: 260, label: '联系电话', name: 'title', type: FormType.InputNumber, required: true, minLength: 9, maxLength: 50, patternList: [{ pattern: /^[\s\S]{9,50}$/, message: '9～50个字' }], placeholder: '请输入标题，9~50个字', showCount: true },
  ],
