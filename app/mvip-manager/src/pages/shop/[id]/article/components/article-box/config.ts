...
export const articleForm: FormConfig = {
  ...
  children: [
    ...
    { formItemWidth: 150, className: 'f-img', label: '图片信息', name: 'imgInfo', type: FormType.ImgUpload, required: false, maxLength: 1, images: [{ uploadType: 2, text: '用于正文介绍', name: 'contentImg', maxSize: 3, cropProps: { aspectRatio: 300 / 200, autoAspectRatio: true }, aspectRatio: 300 / 200 }], tip: '图片格式：jpg、jpeg、png，大小不超过3M，图片比例3：2，尺寸需大于300*200' },
