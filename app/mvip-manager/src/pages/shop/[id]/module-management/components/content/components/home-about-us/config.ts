...
export const aboutUsForm: FormConfig = {
  ...
  children: [
    ...
    {
      formItemWidth: 150, label: '模块图片', name: 'media', type: FormType.ImgUpload, required: false, maxLength: 1, images: [{ uploadType: 2, text: '', name: 'media', maxSize: 3, cropProps: { aspectRatio: 400 / 300 }, aspectRatio: 400 / 300 }],
