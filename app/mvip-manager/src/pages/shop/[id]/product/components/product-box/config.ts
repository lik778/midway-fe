...
export const productForm: FormConfig = {
  ...
  children: [
    ...
    {
      formItemWidth: 150, label: '用于封面', name: 'headImg', type: FormType.ImgUpload, required: false, maxLength: 1, images: [{ text: '用于封面', name: 'headImg', maxSize: 3, }],
      tip: '图片格式：jpg、jpeg、png，大小不超过3M，图片比例3：2，尺寸需大于300*200'
    },
    {
      formItemWidth: 150, label: '用于正文', name: 'contentImg', type: FormType.ImgUpload, required: false, maxLength: 5, images: [{ text: '用于正文介绍', name: 'contentImg', maxSize: 3, }],
      tip: '图片格式：jpg、jpeg、png，大小不超过3M，图片比例3：2，尺寸需大于300*200'
    },
