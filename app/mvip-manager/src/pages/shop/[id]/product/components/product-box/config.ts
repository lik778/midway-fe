...
export const productForm: FormConfig = {
  ...
  children: [
    ...
    {
      formItemWidth: 150, label: '用于封面', name: 'headImg', type: FormType.ImgUpload, required: false, maxLength: 1, images: [{ uploadType: 2, showVideo: true, text: '用于封面', name: 'headImg', maxSize: 3, cropProps: { aspectRatio: 300 / 200 }, aspectRatio: 300 / 200 }],
