...
export const CustomerSetFormConfigFn: (key: string | number, imageChange: (...arg: any) => any) => FormConfig = (key, imageChange) => ({
  ...
  children: [
    ...
    {
      label: '上传图片', name: 'urlImg', maxLength: 1, type: FormType.ImgUpload, images: [{ uploadType: 2, text: '', name: 'urlImg', maxSize: 3, cropProps: { aspectRatio: 595 / 222 }, aspectRatio: 595 / 222 }],
