...
export const CustomerSetFormConfigFn: (key: string | number, imageChange: (...arg: any) => any) => FormConfig = (key, imageChange) => ({
  ...
  children: [
    ...
    {
      label: '上传图片', name: 'urlImg', maxLength: 1, type: FormType.ImgUpload, images: [{ text: '', name: 'urlImg', maxSize: 3, rule: [{ required: true, message: `请上传图片` }], cropProps: { aspectRatio: 595 / 222 } }],
