...
const MetasSelect: FC<{
  ...
  return <>
    ...
    <Form.Item style={cascaderValue.length >= 0 && thirdDataLength && thirdDataLength > 0 ? {} : {
      ...
      <MetasCheckbox item={item} initialValues={initialValues} cascaderValue={cascaderValue} handleChangeCheckboxValue={setCheckboxValue} setThirdDataLength={setThirdDataLength}></MetasCheckbox>
    </Form.Item>
