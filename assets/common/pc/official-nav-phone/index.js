...
const set400NumbertimeOut = function () {
  let number = 180
  const phoneNumTipText = $('.official-nav-phone-num-box>.official-nav-phone-num-tip>.tip-text')
...
export const initPhone = function () {
  $(document).on('ready', async function () {
    // 如果是sem页面 有点击显示电话功能
    if (isSem) {
      const phoneNumBox = $('.official-nav-phone-num-box')
      const phoneNum = $('.official-nav-phone-num-box>.official-nav-phone-num')
      const phoneNumTip = $('.official-nav-phone-num-box>.official-nav-phone-num-tip')
      const phone400Action = $('.official-nav-phone-400-action')
      const phone400ActionBtn = $('.official-nav-phone-400-action .btn')
