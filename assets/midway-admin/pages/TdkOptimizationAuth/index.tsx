...
import { setTdkOptimizationAuthApi } from '../../api/commonFunction'

const TdkOptimizationAuth = () => {
  ...
  const upload = async () => {
    ...
    const res = await setTdkOptimizationAuthApi({ id })
    if (res.success) {
...
export default TdkOptimizationAuth